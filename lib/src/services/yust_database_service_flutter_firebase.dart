...
class YustDatabaseServiceFirebase implements YustDatabaseServiceInterface {
  ...
  YustDatabaseServiceFirebase({this.dbLogCallback})
  ...
  Future<T> saveNewDoc<T extends YustDoc>(
    ...
    doc = initDoc<T>(docSetup, doc: doc);

    if (onInitialized != null) {
      await onInitialized(doc);
    }
